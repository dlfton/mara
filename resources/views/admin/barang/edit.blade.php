        ...
        <div class="app-content pt-3 p-md-3 p-lg-4">
            <div class="container-xl">
                <div class="app-card shadow-sm mb-4 p-4">
                    ...
                    <div class=""></div>
                    {{-- form --}}
                    <form action="{{ url('kategori/'.$item->id) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="row">
                            ...
                            <div class="form-outline mb-4">
                                ...
                                <input type="text" id="loginName"
                                    ...
                                    value="{{ $item->slug }}" required autocomplete="slug" autofocus />
                            ...
                            <div class="form-outline mb-4">
                                ...
                                <textarea id="loginName" class="form-control @error('desc')is-invalid @enderror" name="desc" rows="3" required>{{ $item->desc }}</textarea>
                            ...
                            <div class="form-outline mb-4 col-8">
                                ...
                                <input type="file" id="loginName"
                                    ...
                                    autocomplete="image" autofocus /> <br />
                                <img src="{{ asset('/uploads/category/' . $item->image) }}" alt="" width="200"
                                    height="150" />
                            ...
                            <div class="form-outline mb-4">
                                ...
                                <textarea id="loginName" class="form-control @error('meta_keyword')is-invalid @enderror" name="meta_keyword"
                                    rows="3" required>{{ $item->meta_keyword }}</textarea>
                            ...
                            <div class="form-outline mb-4">
                                ...
                                <textarea id="loginName" class="form-control @error('meta_desc')is-invalid @enderror" name="meta_desc" rows="3"
                                    required>{{ $item->meta_desc }}</textarea>
