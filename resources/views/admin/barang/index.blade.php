                        ...
                        <div class="app-card-body p-3 p-lg-4">
                            ...
                            <div class="row gx-5 gy-3">
                                <div class="col-12 col-lg-9">
                                    ...
                                    <div>betonk created this application with strong capabilities and intentions. This
                                        template is powered by bootstrap 5, with a simple appearance, easy to understand
                                        and use.</div>
                                </div>
                                <!--//col-->
